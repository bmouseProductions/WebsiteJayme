  ...
  return (
    <section className="relative bg-[#18231E] text-white py-16">
      ...
      <div className="relative max-w-screen-lg mx-auto text-center px-8">
        ...
        {/* Título */}
        <h1 className="text-4xl md:text-6xl font-bold tracking-wide leading-snug">
        ...
        {/* Botão */}
        <button className="mt-8 px-6 py-3 bg-red-500 text-white text-lg font-medium rounded-full hover:bg-red-600 transition">
          Saiba Mais
        </button>
